 ...
 *
 */
public class MeijiMilk5x12ChokoPuzzle extends MeijiMilkChokoPuzzle {

	public MeijiMilk5x12ChokoPuzzle() {
		this.setId(PuzzleId.MILK_5x12);
		this.setPieces(createPieces());
		this.setBoard(new Board(5, 12));
	}
}
