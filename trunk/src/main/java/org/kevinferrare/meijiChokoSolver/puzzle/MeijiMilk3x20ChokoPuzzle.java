 ...
 *
 */
public class MeijiMilk3x20ChokoPuzzle extends MeijiMilkChokoPuzzle {

	public MeijiMilk3x20ChokoPuzzle() {
		this.setId(PuzzleId.MILK_3x20);
		this.setPieces(createPieces());
		this.setBoard(new Board(3, 20));
	}
}
